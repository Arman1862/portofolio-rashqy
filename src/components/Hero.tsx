...
const softwareSkills: SoftwareSkill[] = [
  ...
  { 
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Adobe_Photoshop_Lightroom_Classic_CC_icon.svg/1280px-Adobe_Photoshop_Lightroom_Classic_CC_icon.svg.png?_=20200616120028" 
  },
  { 
  ...
  { 
    name: "Canva", 
    svg: (
      <svg viewBox="0 0 508 508" className="w-8 h-8 transition-transform duration-300 group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2">
