...
import { Film, Camera, Play, Grid, ArrowLeft } from "lucide-react";
...
export default function WorksPage() {
  ...
  const filmWorks = works.filter((w) => w.category === "video");
      ...
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm md:text-base text-muted-foreground font-sans max-w-xl font-light leading-relaxed">
            Explore the creative outputs of Rasqhy. Scroll down to browse through video editing projects and photography sessions.
          </p>
        </div>

        {/* SECTION 1: FILMS & EDITING */}
        <section id="films-section" className="space-y-10 scroll-mt-24">
          <div className="border-b border-white/5 pb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold font-heading text-white">FILMS & EDITING</h2>
            </div>
          </div>
        ...
        <section id="photography-section" className="space-y-10 scroll-mt-24">
          <div className="border-b border-white/5 pb-6 flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] font-bold tracking-widest text-purple-500 uppercase font-sans">Category 02</span>
